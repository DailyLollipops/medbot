...
<header class="u-clearfix u-grey-5 u-header u-sticky u-sticky-6c84 u-valign-middle u-header" id="sec-3e0f" data-animation-name="" data-animation-duration="0" data-animation-delay="0" data-animation-direction="">
  ...
  <nav class="u-align-left u-menu u-menu-one-level u-offcanvas u-menu-1">
    ...
    <div class="u-custom-menu u-nav-container">
      <ul class="u-nav u-unstyled u-nav-1">
        ...
        <li class="u-nav-item">
          <a class="u-button-style u-nav-link u-text-active-palette-1-base u-text-hover-palette-2-base" href="/medbot/public/manage" style="padding: 10px 20px;">Manage</a>
        </li>
        <li class="u-nav-item">
