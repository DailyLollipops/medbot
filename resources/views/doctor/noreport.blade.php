@extends('layout',[$style = 'doctor/noreport', $title = 'User Report'])
...
<section class="u-clearfix u-section-2" id="sec-5d60">
  <div class="u-clearfix u-sheet u-sheet-1">
    ...
    <h4 class="u-text u-text-1">It seems that the user haven't taken any readings yet that's why we can't display anything here</h4>
    <h4 class="u-text u-text-default-lg u-text-default-md u-text-default-sm u-text-default-xl u-text-2">Suggestions:</h4>
    <ul class="u-text u-text-3">
      <li>
        <span style="font-size: 24px;">Have them visit local Med-bot and start measuring your vital signs</span>
      </li>
    </ul>
  </div>
</section>
