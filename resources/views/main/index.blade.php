@extends('layout',[$style = 'index', $title = 'Home'])
  ...
  @else
    <section class="u-clearfix u-section-1" id="sec-b481">
      <div class="u-clearfix u-sheet u-sheet-1">
        <img class="u-image u-image-contain u-image-default u-preserve-proportions u-image-1" src="images/logo.png" alt="" data-image-width="229" data-image-height="220">
        <h1 class="u-text u-text-1">Med-bot</h1>
