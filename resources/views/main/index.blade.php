...
<section class="u-clearfix u-section-1" id="sec-b481">
  <div class="u-clearfix u-sheet u-sheet-1">
    <img class="u-image u-image-contain u-image-default u-preserve-proportions u-image-1" src="{{ secure_asset('images/logo.png') }}" alt="" data-image-width="229" data-image-height="220">
        ...
        <div class="u-align-center u-container-style u-list-item u-repeater-item">
          <div class="u-container-layout u-similar-container u-container-layout-1">
            <span class="u-file-icon u-icon u-icon-circle u-palette-1-base u-icon-1">
              <img src="{{ secure_asset('images/feature1.png') }}" alt="">
            </span>
        ...
        <div class="u-align-center u-container-style u-list-item u-repeater-item">
          <div class="u-container-layout u-similar-container u-container-layout-2">
            <span class="u-file-icon u-icon u-icon-circle u-palette-1-base u-icon-2">
              <img src="{{ secure_asset('images/feature2.png') }}" alt="">
            </span>
        ...
        <div class="u-align-center u-container-style u-list-item u-repeater-item">
          <div class="u-container-layout u-similar-container u-container-layout-3">
            <span class="u-file-icon u-icon u-icon-circle u-palette-1-base u-icon-3">
              <img src="{{ secure_asset('images/feature3.png') }}" alt="">
            </span>
